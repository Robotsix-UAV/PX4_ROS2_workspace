...
if ! grep -q "/fmu/out/estimator_status" ./src/modules/uxrce_dds_client/dds_topics.yaml; then
    sed -i '/publications:/a \  - topic: \/fmu\/out\/estimator_status\n    type: px4_msgs::msg::EstimatorStatus' ./src/modules/uxrce_dds_client/dds_topics.yaml
fi
